...
export function Footer() {
  return (
    <footer className="border-t-4 border-border bg-card text-card-foreground mt-20">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-primary border-2 border-border">
            ...
            <div className="flex gap-4">
              <a href="#" className="p-2 bg-background border-2 border-border hover:bg-primary hover:text-white transition-colors rounded-md">
          ...
          <div className="bg-background border-4 border-border p-4 rounded-lg neo-shadow-sm">
